...
export default function ChatPage() {
  ...
  return (
    <div className="h-[660px] flex overflow-hidden">
      {/* Coluna dos Chats */}
      <div className="flex flex-col w-1/3 h-full overflow-y-auto ">
        <ScrollArea className="flex-1 rounded-tl-md rounded-bl-md bg-green-300 border-black border-solid border-2">
          <div className="p-4 space-y-2">
            ...
            {[...Array(40)].map((_, index) => (
              <Button
                ...
                className={`flex items-center justify-start w-full p-4 pt-6 pb-6 mb-2 text-left bg-white shadow-md rounded-lg transition-transform transform hover:scale-105 ${selectedChat === index
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-end bg-blue-300">
              <div className=" sm:max-w-[25%] md:max-w-[35%] lg:max-w-[50%] bg-green-200 p-3 rounded-lg text-black break-words overflow-wrap break-word">
                <p className="break-words">
                  Mensagem do usuáriooooooooooooooooooooooooooooooooobbdfjsdbjsdbhjssdbjsdbfhdsbjhsdhdjs jshdbdshbsdjbf
                  lsjfndjskdfsdsjds
                  sklfnsdlndslfndsnsdkfnskdn
                </p>
              </div>
            </div>
            ...
            <div className="flex justify-start">
              <div className="max-w-[50%] sm:max-w-[25%] md:max-w-[35%] lg:max-w-[50%] bg-white p-3 rounded-lg shadow-md text-black break-words overflow-wrap break-word">
                <p className="break-words">
                  Mensagem de quem ele está conversandooooooooooooooooooooooooooooooooooooooooooooooooooooo
                </p>
              </div>
            </div>
          </div>
